...
function fingerprintFor({ body = 'For you', snapshot = true, currentBody = body } = {}) {
  const rows = {
    orders: { data: { order_status: 'unpaid', checkout_currency: 'USD' }, error: null },
  ...
  return module.exports.createOrderCheckoutFingerprint('order-1')
}
