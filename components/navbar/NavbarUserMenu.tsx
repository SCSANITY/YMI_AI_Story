...
export function NavbarUserMenu({
  ...
  return (
    <div className="flex items-center">
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-56 animate-in rounded-xl border border-white/85 bg-white/92 py-1 shadow-[0_14px_38px_rgba(0,0,0,0.16),inset_0_1px_0_rgba(255,255,255,0.92)] backdrop-blur-2xl backdrop-saturate-150 duration-200 fade-in slide-in-from-top-2">
