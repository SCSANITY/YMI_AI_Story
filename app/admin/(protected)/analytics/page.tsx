  ...
  return (
    <>
      ...
      <section className="rounded-[26px] border border-white/10 bg-white/[0.06] p-8 shadow-[0_22px_70px_rgba(0,0,0,0.24)] backdrop-blur-2xl">
        <p className="text-xs font-bold uppercase tracking-[0.22em] text-amber-300">Data Overview</p>
        <h2 className="mt-1 text-2xl font-bold text-white">Sales Analytics</h2>
        <p className="mt-3 max-w-lg text-sm leading-6 text-slate-400">
          Order, payment, and job visualizations are planned for this section. Connect DB tables —
          orders, payments, jobs — to surface revenue metrics, conversion rates, and production throughput.
        </p>
