    ...
    <div className="page-surface min-h-screen">
      <div className="mx-auto max-w-4xl px-4 py-10 md:px-8 md:py-14">
        <section className="glass-panel rounded-[2rem] px-6 py-8 md:px-10 md:py-12">
          <div className="inline-flex rounded-full border border-white/70 bg-white/65 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.1em] text-amber-600 shadow-sm">
            Impact
          </div>
